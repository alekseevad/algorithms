...
public class Solution {
    public static void main(String[] args) {
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader("src/ru.alekseev.YandexContestArseniy.Yandex_Meet_Up_3_Arseniy.Yandex_Meet_Up_2_Arseniy/input.txt"))){
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter("src/ru.alekseev.YandexContestArseniy.Yandex_Meet_Up_3_Arseniy.Yandex_Meet_Up_2_Arseniy/output.txt"));
