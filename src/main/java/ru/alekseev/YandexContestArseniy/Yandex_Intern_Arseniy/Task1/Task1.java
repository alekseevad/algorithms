package ru.alekseev.YandexContestArseniy.Yandex_Intern_Arseniy.Task1;
...
public class Task1 {
    public static void main(String[] args) {
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader("src/ru.alekseev.YandexContestArseniy.Yandex_Intern_Arseniy/Task1/input.txt"))) {
